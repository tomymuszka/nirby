                                ...
                                children: [
                                  ...
                                  Flexible(
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        context
                                            .pushNamed('terminos_condiciones');
                                      },
                                      child: RichText(
                                        textScaler:
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (_model.terminosaceptadosValue != true) {
                                      await showDialog(
                                        context: context,
                                    ...
                                    if (_model.emailexiste != null &&
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            title: const Text('Email registrado'),
                                            content: const Text(
                                    ...
                                    if ((_model.passwordTextController1.text ==
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            title:
                                                const Text('Contraseñas difernetes'),
                                            content: const Text(
