        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [Color(0xFF515EEB), Color(0xFFC1358D)],
              stops: [0.0, 1.0],
                              ...
                              Row(
                                ...
                                children: [
                                  Theme(
                                    ...
                                    child: Checkbox(
                                      value: _model.terminosaceptadosValue ??=
                                          false,
                                      onChanged: (newValue) async {
                                        safeSetState(() =>
                                            _model.terminosaceptadosValue =
                                                newValue!);
                                      },
                                      side: BorderSide(
                                        width: 2,
                                ...
                                builder: (context) => Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if (_model.terminosaceptadosValue !=
                                          true) {
                                        await showDialog(
                                          context: context,
                                            ...
                                            return Dialog(
                                              ...
                                              child: GestureDetector(
                                                ...
                                                child:
                                                  ...
                                                  titulo:
                                                      'Faltan términos y condiciones',
                                                  cuerpo:
                                                      'Debés aceptar los términos y condiciones para poder crear tu cuenta.',
                                                  buttonstring: 'Ok',
                                                ),
                                              ),
                                            );
                                      ...
                                      if (_model.emailexiste != null &&
                                          (_model.emailexiste)!.isNotEmpty) {
                                        await showDialog(
                                          context: context,
                                          builder: (dialogContext) {
                                            return Dialog(
                                              ...
                                              child: GestureDetector(
                                                ...
                                                child:
                                                  ...
                                                  cuerpo:
                                                      'El email que ingresaste ya se encuentra registrado. Ingresá con otro o restablecé tu contraseña desde la pantalla de inicio de sesión.',
                                                  buttonstring: 'Ok',
                                                ),
                                              ),
                                            );
                                      ...
                                      if ((_model.passwordTextController1
                                          ...
                                          (_model.passwordTextController2
                                                      .text !=
                                                  '')) {
                                        FFAppState().emailRegistro = _model
                                            .emailAddressTextController.text;
                                        FFAppState().contrasenaRegistro =
                                            _model.passwordTextController1.text;
                                        safeSetState(() {});

                                        context
                                            .pushNamed(Signin1Widget.routeName);
                                      } else {
                                        await showDialog(
                                          context: context,
                                          builder: (dialogContext) {
