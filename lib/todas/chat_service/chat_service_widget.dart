...
class ChatServiceWidget extends StatefulWidget {
  ...
  static String routeName = 'chatService';
  static String routePath = '/chatService';
...
class _ChatServiceWidgetState extends State<ChatServiceWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      await _model.chat?.animateTo(
        _model.chat!.position.maxScrollExtent,
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    final containerServiceChatRow =
                                        containerServiceChatRowList.isNotEmpty
                                            ? containerServiceChatRowList.first
                                            : null;
                                                              ...
                                                              child: Align(
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child: Text(
                                                                    valueOrDefault<
                                                                        String>(
                                                                      functions.verifyIfIsANumber(containerServiceChatRow?.servicePrecio) ==
                                                                              true
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: StreamBuilder<List<ChatsRow>>(
                                      stream: _model.chatSupabaseStream ??=
                                          SupaFlow.client
                                              .from("chats")
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<ChatsRow> chatChatsRowList =
                                            snapshot.data!;

                                        return SingleChildScrollView(
                                          controller: _model.chat,
                                          child: Column(
                                            mainAxisSize: MainAxisSize.min,
                                            mainAxisAlignment:
                                                MainAxisAlignment.start,
                                            children: List.generate(
                                                chatChatsRowList.length,
                                                (chatIndex) {
                                              final chatChatsRow =
                                                  chatChatsRowList[chatIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 0.0, 0.0, 10.0),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          if (!(_model.inputTextTextController
                                                      .text !=
                                                  '')) {
                                            return;
                                          }
