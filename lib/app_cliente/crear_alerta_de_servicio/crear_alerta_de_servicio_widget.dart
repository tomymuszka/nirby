                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        title: const Text(
                                                                            'Eliminar imagen'),
                                                                        content:
                                                                            const Text('Estas seguro de que deseas eliminar esta imagen?'),
                                                                        actions: [
                                                                          TextButton(
                                                                            onPressed: () =>
                          ...
                          onPressed: () async {
                            ...
                            if (_model.radioButtonValue == null) {
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: const Text('Falta zona'),
                                    content: const Text('Debés seleciconar una zona'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
                                            Navigator.pop(alertDialogContext),
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: const Text('¡Alerta creada con éxito!'),
                                  content: const Text(
                            ...
                            context.goNamed('alertasDeServicioHistoria');
