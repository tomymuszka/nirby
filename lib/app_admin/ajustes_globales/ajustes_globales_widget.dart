...
class _AjustesGlobalesWidgetState extends State<AjustesGlobalesWidget> {
  late AjustesGlobalesModel _model;
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<GlobalesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<GlobalesRow> ajustesGlobalesGlobalesRowList = snapshot.data!;

        final ajustesGlobalesGlobalesRow =
            ajustesGlobalesGlobalesRowList.isNotEmpty
                ? ajustesGlobalesGlobalesRowList.first
                : null;
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    'Valor de la suscripción mensual',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Inter',
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller: _model.textController1 ??=
                                    ...
                                    text: ajustesGlobalesGlobalesRow
                                        ?.suscripcionMensual
                                        .toString(),
                                  ),
