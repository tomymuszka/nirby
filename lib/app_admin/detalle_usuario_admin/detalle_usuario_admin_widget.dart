...
class DetalleUsuarioAdminWidget extends StatefulWidget {
  const DetalleUsuarioAdminWidget({
    super.key,
  ...
  State<DetalleUsuarioAdminWidget> createState() =>
      _DetalleUsuarioAdminWidgetState();
}

class _DetalleUsuarioAdminWidgetState extends State<DetalleUsuarioAdminWidget>
    with TickerProviderStateMixin {
  late DetalleUsuarioAdminModel _model;
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsuariosAnaliticasRow>>(
      future: UsuariosAnaliticasTable().querySingleRow(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuariosAnaliticasRow>
            detalleUsuarioAdminUsuariosAnaliticasRowList = snapshot.data!;

        final detalleUsuarioAdminUsuariosAnaliticasRow =
            detalleUsuarioAdminUsuariosAnaliticasRowList.isNotEmpty
                ? detalleUsuarioAdminUsuariosAnaliticasRowList.first
                : null;
                                                  ...
                                                  Flexible(
                                                    child: Padding(
                                                      ...
                                                      child: Text(
                                                        detalleUsuarioAdminUsuariosAnaliticasRow
                                                                    .suscripcionActiva! &&
                                                                (functions.differencebetweendatesmenor90(
                                                                        getCurrentTimestamp,
                                                                        detalleUsuarioAdminUsuariosAnaliticasRow
                                                                            .fechaCreacionSuscripcion) ==
                                                                    true)
                                                            ? 'Sí'
                                                            : 'No',
                                                        style: FlutterFlowTheme
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                Flexible(
                                                                  child: Text(
                                                                    'Conversaciones iniciadas por alertas de servicio',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                Flexible(
                                                                  child: Text(
                                                                    'Conversaciones iniciadas por servicios',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
                                                              ...
                                                              Flexible(
                                                                child: Text(
                                                                  valueOrDefault<
                                                                      String>(
                                                                    detalleUsuarioAdminUsuariosAnaliticasRow
                                                                        .totalAlertasServicioSeleccionadas
                                                                        ?.toString(),
                                                                    '0',
                                                                  ),
                                                                  style: FlutterFlowTheme.of(
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                Flexible(
                                                                  child: Text(
                                                                    'Alertas de servicio seleccionada',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                Flexible(
                                                                  child: Text(
                                                                    'Alertas de servicio interesado',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
