...
/// Pagina del chat
class ChatServiceAdminWidget extends StatefulWidget {
  const ChatServiceAdminWidget({
    super.key,
...
class _ChatServiceAdminWidgetState extends State<ChatServiceAdminWidget> {
  late ChatServiceAdminModel _model;
