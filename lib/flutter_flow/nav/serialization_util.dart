  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case AlertConversationDetailsRow:
            return AlertConversationDetailsRow(data);
          case GlobalesRow:
            return GlobalesRow(data);
          case AlertasServicioResumenAdminRow:
            return AlertasServicioResumenAdminRow(data);
          case ProfessionalAnalyticsRow:
            return ProfessionalAnalyticsRow(data);
          case ChatsRow:
          ...
          case ReviewsWithUserInfoRow:
            return ReviewsWithUserInfoRow(data);
          case ServiceDetailCompleteRow:
            return ServiceDetailCompleteRow(data);
          case CategoriasRow:
            return CategoriasRow(data);
          case ConversationDetailsRow:
