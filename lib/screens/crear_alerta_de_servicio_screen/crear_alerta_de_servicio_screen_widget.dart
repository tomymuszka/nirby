...
import 'crear_alerta_de_servicio_screen_model.dart';
export 'crear_alerta_de_servicio_screen_model.dart';
...
class CrearAlertaDeServicioScreenWidget extends StatefulWidget {
  ...
  State<CrearAlertaDeServicioScreenWidget> createState() =>
      _CrearAlertaDeServicioScreenWidgetState();
}

class _CrearAlertaDeServicioScreenWidgetState
    extends State<CrearAlertaDeServicioScreenWidget> {
  late CrearAlertaDeServicioScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearAlertaDeServicioScreenModel());
