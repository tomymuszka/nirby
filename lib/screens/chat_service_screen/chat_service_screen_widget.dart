...
import 'chat_service_screen_model.dart';
export 'chat_service_screen_model.dart';

/// Pagina del chat
class ChatServiceScreenWidget extends StatefulWidget {
  const ChatServiceScreenWidget({
    super.key,
  ...
  State<ChatServiceScreenWidget> createState() =>
      _ChatServiceScreenWidgetState();
}

class _ChatServiceScreenWidgetState extends State<ChatServiceScreenWidget> {
  late ChatServiceScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatServiceScreenModel());
